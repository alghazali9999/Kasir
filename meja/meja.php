...
<body class="flex bg-gray-100 font-sans">
    ...
    <!-- Main Content -->
    <div class="ml-64 p-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-8">Meja Management</h1>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-x-auto">
            <table class="w-full text-left border-collapse max-w-screen-2xl mx-auto">
                <thead class="bg-gray-200">
                    <tr>
                        <th class="px-6 py-4 font-medium text-gray-700">ID</th>
                        <th class="px-6 py-4 font-medium text-gray-700">Nomor Meja</th>
                        <th class="px-6 py-4 font-medium text-gray-700">Kapasitas</th>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr class="border-b hover:bg-gray-50 transition duration-300">
                            <td class="px-6 py-4"><?php echo htmlspecialchars($row['id_meja']); ?></td>
                            ...
                            <td class="px-6 py-4 flex items-center justify-center gap-3">
                                <!-- Edit -->
                                <a href="edit.php?id=<?php echo $row['id_meja']; ?>"
                                    class="text-blue-500 hover:text-blue-700" title="Edit">
                                    <i class="fas fa-edit text-lg"></i>
                                </a>

                                <!-- Hapus -->
                                <a href="delete.php?id=<?php echo $row['id_meja']; ?>"
