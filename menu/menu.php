...
<body class="flex bg-gray-100 font-sans">
    ...
    <!-- Main Content -->
    <div class="ml-64 p-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-8">Menu Management</h1>
            ...
            <table class="w-full text-left border-collapse max-w-screen-xl mx-auto">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 font-medium text-gray-700">Nama Menu</th>
                        <th class="px-6 py-4 font-medium text-gray-700">Harga</th>
                        <th class="px-6 py-4 font-medium text-gray-700">Kategori</th>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr class="border-b hover:bg-gray-50 transition duration-300">
                            <td class="px-6 py-4"><?php echo htmlspecialchars($row['id_menu']); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($row['nama_menu']); ?></td>
                            <td class="px-6 py-4"><?php echo htmlspecialchars($row['harga']); ?></td>
